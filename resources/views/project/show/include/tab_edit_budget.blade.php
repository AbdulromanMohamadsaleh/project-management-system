<nav>
    ...
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home-{{ $task->TASK_ID }}" type="button" role="tab" aria-controls="nav-home"
        ...
        <form id="signUpForm" method="post" action="{{ route('task.savebudget',$task->TASK_ID) }}">
            ...
            <div class="row mb-5 mb-sm-0">
                <div class=" mb-sm-5">
                    ...
                    <input value="{{ $task->TASK_BUDGET }}" readonly type="number" name="budget" class="form-control" id="projectName">
                    @else
                    <input value="{{ $task->TASK_BUDGET }}" type="number" name="budget" class="form-control mb-2" id="projectName">
                    <button type="submit" style="width: 100%" name="submit" onclick="success()" class="btn btn-success">SAVE</button>
                    @endif
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <form  method="GET"action="{{ route('payment', $task->TASK_ID) }}">
                            ...
                            <button type="submit" class="btn btn-xs btn-success btn-flat show-alert-delete-box1 " data-toggle="tooltip" title='Payment'><i   class='fas fa-check-circle'></i></button>
                          </form>
                    </div>
