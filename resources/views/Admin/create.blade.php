                            ...
                            <div class="row mb-5 mb-sm-0">
                                ...
                                <div class="col-md-6 mb-sm-5">
                                    ...
                                    <input type="date" readonly
                                        ...
                                        name="projectEnd" value="{{ old('projectEnd') }}">
                                    @error('projectEnd')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-sm-5">
                                    ...
                                    <div class="row p-2  ">
                                        <div class="label-left col form-check form-check-inline">
                                            <input required checked class="form-check-input" name="projectDurationFormat"
                                    ...
                                    <div class="taskWrap">
                                        ...
                                        <div class="row d-flex justify-content-end ">
                                            ...
                                            <div class="col-1"><button type="button" disabled title="Delete Task"
                                                    class="d-flex btn btn-danger btn-delete-task "><i
