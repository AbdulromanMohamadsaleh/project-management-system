                        ...
                        <div class="step ">
                            ...
                            <div class="row mb-5 mb-sm-0 ">
                                ...
                                <div class="col-md-6 mb-sm-5">
                                    ...
                                    <input required type="text" name="target" value="{{ $project_detail->TARGET }}"
                            ...
                            <div class="row mb-5 mb-sm-0">
                                <div class="col-md-6 mb-sm-5">
                                    ...
                                    <input required type="date" value="{{ $project_detail->DATE_START }}"
                                        class="form-control @error('projectStart') is-invalid @enderror" id="projectStart"
                                        name="projectStart">
                                    @error('projectStart')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-sm-5">
                                    ...
                                    <input type="date" readonly
                                        class="form-control @error('projectEnd') is-invalid @enderror" id="projectEnd"
                                        name="projectEnd" value="{{ $project_detail->DATE_END }}">
                                    @error('projectEnd')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-5 mb-sm-0">
                                <div class="col-md-6 mb-sm-5">
                                    ...
                                    <div class="row p-2  ">
                                        ...
                                        <div class="label-left col form-check form-check-inline">
                                            <input class="form-check-input" name="projectDurationFormat" type="radio"
                                                id="week" {{ $project_detail->DURATION_TYPE == 1 ? 'checked' : '' }}
                                                value="week">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="row p-2 px-5 ">
                                            <div style="text-align: left" class="mb-3 form-check form-check-inline">
                                                <input class="form-check-input" name="isIncludeWeekend" type="radio"
                                                    id="yes" value="yes"
                            ...
                            <div class="row mb-5 mb-sm-0">
                                <div class="col-md-6 mb-sm-5">
                                    ...
                                    <input type="text" name="location" value="{{ $project_detail->LOCATION }}"
                                ...
                                <div class="col-md-6 mb-sm-5  mb-3">
                                    <div class="input-group">
                                        ...
                                        <input name="budget" value="{{ $project_detail->BUDGET }}" type="number"
                            ...
                            <div class="row mb-5 mb-sm-0">
                                ...
                                <div class="col-md-6 mb-sm-5">
                                    ...
                                    <select required style="width: 100%;padding: 9px 14px;border-color: rgb(33, 37, 41);"
                                        class="form-select js-example-basic-multiple" id="projectTeam"
                                        name="projectTeam[]" multiple="multiple">
                                        @if (count($team) > 0)
                                            @foreach ($team as $staff)
                                                <option {{ in_array($staff->LOGIN_ID, $projectTeams) ? 'selected' : '' }}
