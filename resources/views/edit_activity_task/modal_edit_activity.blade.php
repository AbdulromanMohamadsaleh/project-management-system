<button style="background-color:orange" type="button" class="btn btn-warning"
    data-bs-toggle="modal" data-bs-target="#modalactivity-{{ $act->ACTIVITY_ID }}">
    <i class="bi bi-pencil"></i>
</button>

<!-- Modal -->
<div class="modal fade" id="modalactivity-{{ $act->ACTIVITY_ID }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
