...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2022 at 04:25 AM
...
INSERT INTO `prj_detail` (`DETAIL_ID`, `NAME_PROJECT`, `REASONS`, `OBJECTIVE`, `LOCATION`, `TARGET`, `BUDGET`, `RESULT`, `DATE_START`, `DATE_END`, `DATE_SAVE`, `RECORD_CREATOR`, `PROPONEN_NAME`) VALUES
...
--
-- Table structure for table `prj_sub_activity`
--

CREATE TABLE `prj_sub_activity` (
  `SUB_ACTIVITY_ID` int(11) NOT NULL,
  `NAME_SUB_ACTIVITY` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `ACTIVITY_ID` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `DAY` smallint(10) NOT NULL,
  `STATUS` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `prj_sub_activity`
--

INSERT INTO `prj_sub_activity` (`SUB_ACTIVITY_ID`, `NAME_SUB_ACTIVITY`, `ACTIVITY_ID`, `DAY`, `STATUS`) VALUES
(11, 'aaa', '33', 5, 0),
(12, 'ddd', '33', 4, 0),
(13, 'dddddddd', '33', 5, 0),
...
--
-- Indexes for table `prj_sub_activity`
--
ALTER TABLE `prj_sub_activity`
...
--
-- AUTO_INCREMENT for table `prj_sub_activity`
--
ALTER TABLE `prj_sub_activity`
  MODIFY `SUB_ACTIVITY_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
